# **M2 Domain** 
This is a dApp theat is built on Polygon network. As usual, Reactjs is used on the frontend with Tailwind css together with QuickNode which is used for integrating our Metamask wallet. The dependency, ether, Hardhat, Openzeppelin, Polygon pos chain was also used in the development to provide chieve access to domain service on polygon.
## Built-with
